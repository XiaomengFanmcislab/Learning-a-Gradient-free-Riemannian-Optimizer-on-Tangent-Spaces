...
class MNIST(data.Dataset):
    def __init__(self, filepath=None,train=True):
        ...
        self.train_data=np.load(filepath+'/training_images.npy')
        self.train_labels=np.load(filepath+'/training_labels.npy')
        self.test_data=np.load(filepath+'/test_images.npy')
        self.test_labels=np.load(filepath+'/test_labels.npy')
